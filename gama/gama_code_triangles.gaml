...
experiment MainVisualize type: gui virtual: true {
    ...
    parameter "Number of Agents" var: number_of_agents <- 4 min:0 max:10 category: "Connection Variables";
    ...
    parameter "offset 1 " var: offset_1 <- {10,133,0} category: "Alignment";
    parameter "offset 2" var: offset_2 <- {9,133.5,0} category: "Alignment";
    parameter "offset 3" var: offset_3 <- {10,133,0} category: "Alignment";
    parameter "offset 4" var: offset_4 <- {9.5,134,0} category: "Alignment";
